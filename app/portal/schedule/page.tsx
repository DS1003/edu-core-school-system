...
export default function Page() {
  ...
  const descText = isPt 
    ? `As funcionalidades para "Emploi du temps" estarão disponíveis em breve na próxima atualização.` 
    : `Les fonctionnalités pour "Emploi du temps" seront bientôt disponibles dans la prochaine mise à jour.`
