...
export default function Page() {
  ...
  const descText = isPt 
    ? `As funcionalidades para "Contact" estarão disponíveis em breve na próxima atualização.` 
    : `Les fonctionnalités pour "Contact" seront bientôt disponibles dans la prochaine mise à jour.`
