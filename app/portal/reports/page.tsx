...
export default function Page() {
  ...
  const descText = isPt 
    ? `As funcionalidades para "Bulletins" estarão disponíveis em breve na próxima atualização.` 
    : `Les fonctionnalités pour "Bulletins" seront bientôt disponibles dans la prochaine mise à jour.`
