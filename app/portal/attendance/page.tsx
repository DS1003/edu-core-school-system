...
export default function Page() {
  ...
  const descText = isPt 
    ? `As funcionalidades para "Présences" estarão disponíveis em breve na próxima atualização.` 
    : `Les fonctionnalités pour "Présences" seront bientôt disponibles dans la prochaine mise à jour.`
