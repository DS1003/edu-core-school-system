...
export default function Page() {
  ...
  const descText = isPt 
    ? `As funcionalidades para "Frais de scolarité" estarão disponíveis em breve na próxima atualização.` 
    : `Les fonctionnalités pour "Frais de scolarité" seront bientôt disponibles dans la prochaine mise à jour.`
