...
export default function Page() {
  ...
  const descText = isPt 
    ? `As funcionalidades para "Factures" estarão disponíveis em breve na próxima atualização.` 
    : `Les fonctionnalités pour "Factures" seront bientôt disponibles dans la prochaine mise à jour.`
