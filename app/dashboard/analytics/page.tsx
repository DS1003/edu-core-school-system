...
export default function Page() {
  ...
  const descText = isPt 
    ? `As funcionalidades para "Analyses & Statistiques" estarão disponíveis em breve na próxima atualização.` 
    : `Les fonctionnalités pour "Analyses & Statistiques" seront bientôt disponibles dans la prochaine mise à jour.`
