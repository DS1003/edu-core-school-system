...
export default function Page() {
  ...
  const descText = isPt 
    ? `As funcionalidades para "Communication" estarão disponíveis em breve na próxima atualização.` 
    : `Les fonctionnalités pour "Communication" seront bientôt disponibles dans la prochaine mise à jour.`
