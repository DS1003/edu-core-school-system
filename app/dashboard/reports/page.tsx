...
export default function Page() {
  ...
  const descText = isPt 
    ? `As funcionalidades para "Bulletins Scolaires" estarão disponíveis em breve na próxima atualização.` 
    : `Les fonctionnalités pour "Bulletins Scolaires" seront bientôt disponibles dans la prochaine mise à jour.`
