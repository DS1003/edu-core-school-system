...
export default function Page() {
  ...
  const descText = isPt 
    ? `As funcionalidades para "Rôles & Permissions" estarão disponíveis em breve na próxima atualização.` 
    : `Les fonctionnalités pour "Rôles & Permissions" seront bientôt disponibles dans la prochaine mise à jour.`
