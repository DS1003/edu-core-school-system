...
export default function Page() {
  ...
  const descText = isPt 
    ? `As funcionalidades para "Intégrations" estarão disponíveis em breve na próxima atualização.` 
    : `Les fonctionnalités pour "Intégrations" seront bientôt disponibles dans la prochaine mise à jour.`
  ...
  return (
    ...
    >
      ...
      <div className="bg-card border border-border rounded-2xl p-8 text-center flex flex-col items-center justify-center min-h-[400px]">
        <Plug className="w-16 h-16 text-muted-foreground/30 mb-4" />
