...
export default function Page() {
  ...
  const descText = isPt 
    ? `As funcionalidades para "Affectations Enseignants" estarão disponíveis em breve na próxima atualização.` 
    : `Les fonctionnalités pour "Affectations Enseignants" seront bientôt disponibles dans la prochaine mise à jour.`
  ...
  return (
    ...
    >
      <div className="flex items-center gap-3 mb-6">
        ...
        <div>
          <h1 className="text-2xl font-bold">Affectations Enseignants</h1>
