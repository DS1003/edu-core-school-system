...
export default function Page() {
  ...
  const descText = isPt 
    ? `As funcionalidades para "Matières" estarão disponíveis em breve na próxima atualização.` 
    : `Les fonctionnalités pour "Matières" seront bientôt disponibles dans la prochaine mise à jour.`
