...
export default function Page() {
  ...
  const descText = isPt 
    ? `As funcionalidades para "Statistiques des notes" estarão disponíveis em breve na próxima atualização.` 
    : `Les fonctionnalités pour "Statistiques des notes" seront bientôt disponibles dans la prochaine mise à jour.`
  ...
  return (
    ...
    >
      <div className="flex items-center gap-3 mb-6">
        ...
        <div>
          <h1 className="text-2xl font-bold">Statistiques des notes</h1>
