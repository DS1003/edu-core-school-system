...
export default function Page() {
  ...
  const descText = isPt 
    ? `As funcionalidades para "Niveaux" estarão disponíveis em breve na próxima atualização.` 
    : `Les fonctionnalités pour "Niveaux" seront bientôt disponibles dans la prochaine mise à jour.`
