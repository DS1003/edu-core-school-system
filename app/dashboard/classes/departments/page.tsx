...
export default function Page() {
  ...
  const descText = isPt 
    ? `As funcionalidades para "Filières" estarão disponíveis em breve na próxima atualização.` 
    : `Les fonctionnalités pour "Filières" seront bientôt disponibles dans la prochaine mise à jour.`
