...
export default function Page() {
  ...
  const descText = isPt 
    ? `As funcionalidades para "Documents" estarão disponíveis em breve na próxima atualização.` 
    : `Les fonctionnalités pour "Documents" seront bientôt disponibles dans la prochaine mise à jour.`
