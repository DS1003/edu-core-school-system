...
export default function Page() {
  ...
  const descText = isPt 
    ? `As funcionalidades para "Années académiques" estarão disponíveis em breve na próxima atualização.` 
    : `Les fonctionnalités pour "Années académiques" seront bientôt disponibles dans la prochaine mise à jour.`
