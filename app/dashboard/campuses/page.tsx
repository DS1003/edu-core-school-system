...
export default function Page() {
  ...
  const descText = isPt 
    ? `As funcionalidades para "Campus" estarão disponíveis em breve na próxima atualização.` 
    : `Les fonctionnalités pour "Campus" seront bientôt disponibles dans la prochaine mise à jour.`
